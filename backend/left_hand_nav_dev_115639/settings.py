"""
Django settings for left_hand_nav_dev_115639 project.
...
ROOT_URLCONF = 'left_hand_nav_dev_115639.urls'
...
WSGI_APPLICATION = 'left_hand_nav_dev_115639.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "left_hand_nav_dev_115639 API",
    "DESCRIPTION": "API documentation for left_hand_nav_dev_115639 App",
    "VERSION": "v1",
}
